...
Восстановлено штатное разворачивание и восстановление окна Windows, включая Snap: готовый кадр масштабируется под окно, выбранное разрешение игры сохраняется.
