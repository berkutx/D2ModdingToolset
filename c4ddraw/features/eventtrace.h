...
enum {
    ...
    C4TRACE_TURN_INFO_ENTER = 220, C4TRACE_TURN_INFO_RETURN = 221,
    C4TRACE_TURN_INFO_COVERAGE = 222,
    C4TRACE_DISCONNECT_ENTER = 223, C4TRACE_DISCONNECT_RETURN = 224,
    C4TRACE_DISCONNECT_COVERAGE = 225,
    C4TRACE_NET_HEARTBEAT = 230
};
